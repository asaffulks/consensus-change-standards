...
\noindent\textbf{Score: Taproot 18/20. BIP-110 3/20.}
...
\begin{itemize}[leftmargin=1.5em, itemsep=4pt]
  ...
  \item Directive on liability for defective products (European Union, adopted 2024), replacing Directive 85/374/EEC. Extends strict product liability to software. Member State transposition deadline approximately two years from entry into force.
