...
\reqitem{A.6}{Platform distribution.} Node-management platform listing the activation client as a selectable version alongside stable Knots releases, with no risk disclosure or visual differentiation at the point of selection (\sect{1.3}, item D; the listing as displayed). [ARCHIVE: capture pending.]
