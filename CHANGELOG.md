...
## v4.1 — June 2026 (revision of the Fourth Edition)

A post-release hardening pass over the Fourth Edition, following a final
comprehensive audit (no defects) and two adversarial "steelman" betterment
reviews, each finding verified to primary source. No holding, score, band, or
quantitative result changed, and the BIP-110 forced-activation analysis is
unchanged; the legal chapter is deepened and several precision points fixed.
Length grew from 92 to 94 pages.

### Legal analysis (§4)

- §4.1: deepened the Restatement (Second) of Torts §552 negligent-
  misrepresentation route — framed the actionable statement as a
  representation of *readiness* and addressed the opinion-vs-fact,
  justifiable-reliance, and loss-causation elements a §552 claim turns on.
- §4.4: limited the implied-covenant theory to its actual reach (*Guz v.
  Bechtel National*, 24 Cal.4th 317 (2000); *Carma Developers v. Marathon
  Development*, 2 Cal.4th 342 (1992)) and pivoted the live pool-operator
  exposure to the §4.1 representation theory.
- §4.5: noted the SEC–CFTC joint interpretive release of March 2026 (91 Fed.
  Reg. 13,714) — Bitcoin and Bitcoin Cash classified as digital commodities,
  no-consideration airdrops outside the investment-contract analysis —
  reinforcing the bracket that asset character is orthogonal to the
  activation-conduct exposure.
- §4.6: named the EU Product Liability Directive by its formal identifier
  (Directive (EU) 2024/2853) on first mention.

### Antitrust note (§5.2)

- Added the FTC Act §5 / facilitating-practice layer (*E.I. du Pont de
  Nemours & Co. v. FTC*, 729 F.2d 128 (2d Cir. 1984)) and *United States v.
  Colgate & Co.*, 250 U.S. 300 (1919) for the unilateral-refusal point
  (trimmed to the §1 independent-action ground), and guarded the §6.6
  "coordination cost" phrasing against an agreement reading.

### Framework, technical, and consistency

- §1.2: corrected the Taproot description — a new output type and Tapscript's
  lifted per-script limits, all within SegWit's existing witness discount and
  weight budget, raising no capacity ceiling (aligning §1.2 with the §5.4
  soft-fork invariant).
- §1.5 / §3.2: reconciled the review-period floors to the current node-upgrade
  cycle and added a "floor, not ceiling" framing.
- §3.4: noted that endogenous hashrate makes the thirty-percent figure the
  optimistic fixed-share corner of the model.
- §5.2 / §6.8 / criterion 20 / Appendix B: contestation lowers a score only
  where opposition goes substantively unaddressed; a basis-less score is
  self-diagnosing; engaging any published readiness standard satisfies
  criterion 20; adopting the model policy language assumes no role in the
  Section-4 liability analysis.
- §3.3 / §5.1: generalized the testnet-deployment floor to "a public test
  network (signet or testnet)."
- References updated for the new authorities (Colgate; du Pont/Ethyl; Guz;
  Carma; 15 U.S.C. §45; the SEC–CFTC release).
